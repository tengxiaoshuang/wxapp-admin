<template>
  <el-dialog :visible.sync="visible" :show-close="false" width="500" :modal="true" :close-on-click-modal="false" :close-on-press-escape="false">
    ...
    <div class="title">投资企业审核</div>
    <el-form ref="enterForm" :model="data" label-position="left" label-width="auto" style="max-width: 500px;">
      <el-form-item label="企业名称" prop="title"><el-input disabled v-model="data.name" clearable /></el-form-item>
      <el-form-item label="企业全称" prop="title"><el-input disabled v-model="data.organizationName" clearable /></el-form-item>
      <el-form-item label="企业介绍" prop="title">
      ...
      <el-form-item label="企业LOGO" prop="title">
      ...
      <el-form-item label="企业电话" prop="title"><el-input disabled v-model="data.phone" clearable /></el-form-item>
      <el-form-item label="企业微信" prop="title"><el-input disabled v-model="data.wxcharts" clearable /></el-form-item>
      <el-form-item label="企业邮箱" prop="title"><el-input disabled v-model="data.email" clearable /></el-form-item>
...
import { getListById, audit } from '@/api/industry';
export default {
  name: 'editfrom',
  // components: {upload},
  props: {
