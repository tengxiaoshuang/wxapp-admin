<template>
  <div class="app-container">
    ...
    <el-table key="listTable" v-loading="listLoading" :data="list" fit highlight-current-row style="width: 100%;">
      ...
      <el-table-column prop="organizationName" align="center" label="企业全称"></el-table-column>
      <el-table-column prop="organizationType" align="center" label="企业类型"></el-table-column>
      <el-table-column prop="wxcharts" align="center" label="企业微信"></el-table-column>
      <el-table-column prop="email" align="center" label="企业邮箱"></el-table-column>
      <el-table-column prop="phone" align="center" label="企业电话"></el-table-column>
...
import { getList } from '@/api/industry';
...
export default {
  ...
  methods: {
    ...
    editUpdateHandle(Id,status) {
      ...
      this.$nextTick(() => {
        this.$refs.editOrder.init(Id,status);
